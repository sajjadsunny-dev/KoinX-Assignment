...
const TeamCard = ({ key, name, Designation, Profile_img, details }) => {
   ...
   return (
      <>
         <div key={key} className="w-full flex items-center bg-teamCardBg p-3 rounded-lg mt-6">
            ...
            <p className="font-inter text-sm leading-[160%] text-navLinkColor ml-8 w-full">{details}</p>
         </div>
      </>
   )
}
